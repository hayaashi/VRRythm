...
public class CutterMove : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        var sliceTest = other.gameObject.GetComponent<SliceTest>();
        ...
        //“®‚«‚ÅØ’f‚·‚éê‡
        var cutPlane = new Plane (Vector3.Cross(-transform.up.normalized, prePos - transform.position).normalized, transform.position);
        Vector3 a = cutPlane.normal.normalized;
